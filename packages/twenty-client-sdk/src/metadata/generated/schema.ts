...
export interface PersonalFinanceData {
    ...
    __typename: 'PersonalFinanceData'
}
...
export interface PersonalFinanceDataGenqlSelection{
    status?: boolean | number
    sections?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface QueryGenqlSelection{
    ...
    personalFinanceData?: (PersonalFinanceDataGenqlSelection & { __args: {input: PersonalFinanceDataInput} })
...
export interface PersonalFinanceDataInput {objectMetadataId: Scalars['UUID'],configuration: Scalars['JSON'],periodStart: Scalars['String'],periodEnd: Scalars['String'],timezone: Scalars['String'],comparisonKind: Scalars['String'],comparisonStart?: (Scalars['String'] | null),comparisonEnd?: (Scalars['String'] | null)}
...
export interface LogicFunctionLogsInput {applicationId?: (Scalars['UUID'] | null),applicationUniversalIdentifier?: (Scalars['UUID'] | null),name?: (Scalars['String'] | null),id?: (Scalars['UUID'] | null),universalIdentifier?: (Scalars['UUID'] | null)}
    ...
    const PersonalFinanceData_possibleTypes: string[] = ['PersonalFinanceData']
    export const isPersonalFinanceData = (obj?: { __typename?: any } | null): obj is PersonalFinanceData => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPersonalFinanceData"')
      return PersonalFinanceData_possibleTypes.includes(obj.__typename)
    }
